    ...
    <>
      <div className="grid">
        ...
        <div className="flex justify-between items-center pt-6 mb-10">
          <Image src={"eth.svg"} alt="ethereum logo" width={30} height={30} />
          <div className="inline-flex items-center gap-2 text-3xl font-medium tracking-tighter">
            ...
            >
              ...
              <path
                d="M11.2,22.2c-6,0-11-4.9-11-11s4.9-11,11-11s11,4.9,11,11S17.2,22.2,11.2,22.2z M11.2,1.8C6,1.8,1.8,6,1.8,11.2&#10;&#9;s4.2,9.5,9.5,9.5s9.5-4.2,9.5-9.5S16.4,1.8,11.2,1.8z"
              />
              <path
                d="M6,9.6c-0.3,0-0.6-0.1-0.8-0.4C4.9,9.1,4.8,8.8,4.8,8.4c0-0.1,0-0.3,0.1-0.4C5,7.9,5,7.7,5.2,7.6c0.4-0.4,1.2-0.4,1.7,0&#10;&#9;C6.9,7.7,7,7.9,7.1,8c0.1,0.1,0.1,0.3,0.1,0.4c0,0.3-0.1,0.6-0.3,0.8C6.6,9.5,6.3,9.6,6,9.6z"
              />
              <path
                d="M16.4,9.6c-0.3,0-0.6-0.1-0.8-0.4c-0.2-0.2-0.4-0.5-0.4-0.8c0-0.1,0-0.3,0.1-0.4c0.1-0.1,0.1-0.3,0.2-0.4&#10;&#9;c0.4-0.4,1.2-0.4,1.7,0c0.1,0.1,0.2,0.2,0.2,0.4c0.1,0.1,0.1,0.3,0.1,0.4c0,0.3-0.1,0.6-0.4,0.8C17,9.5,16.7,9.6,16.4,9.6z"
              />
            </svg>
          </div>
        </div>
