      ...
      <div className="grid grid-cols-2 gap-20 items-center">
        <div className="flex flex-col items-start gap-4">
          <h2 className="text-5xl font-semibold font-[family-name:var(--font-geist-sans)]">
            Built on 5+ networks on the superchain, with core focus on{" "}
            <span className="text-blue-700">$lisk</span>
          </h2>
          <p className="text-xl font-light">
            By leveraging the Optimism superchain, Ace Fantasy is accessible to
            a wider audience, providing a scalable and maintainable solution
            that unlocks the full potential of blockchain gaming, ensuring a
